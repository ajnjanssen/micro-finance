export interface SavingsGoal {
  ...
  budgetType?: "needs" | "wants" | "savings"; // Budget classification (50/30/20)
  ...
  fromAccountId?: string; // Source account for transfers (e.g., checking)
  toAccountId?: string; // Destination account for savings (e.g., savings)
