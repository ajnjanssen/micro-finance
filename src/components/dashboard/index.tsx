...
export default function Dashboard({ currentBalance, accounts, accountBalances }: DashboardProps) {
			...
			{accounts.find(a => a.type === "savings") && (
				<SavingsBreakdown
					savingsAccountBalance={
						accountBalances[accounts.find(a => a.type === "savings")?.id || ""] || 0
					}
					savingsAccountId={
			...
			<div className="card bg-base-100 shadow">
				<div className="card-body p-0">
					<div className="flex justify-between items-center mb-4">
						<div className="flex-1">
							<div className="flex items-center gap-2 mb-2">
								...
								<div className="tooltip tooltip-right" data-tip="Dit toont hoe je totale vermogen zich ontwikkelt als je elke maand je terugkerende inkomsten ontvangt en uitgaven betaalt. Startsaldo + maandelijkse groei.">
							...
							<p className="text-sm text-base-content/60">
								Verwachte ontwikkeling van je <strong>totale vermogen</strong> (alle rekeningen samen) 
								op basis van terugkerende transacties
							</p>
						</div>
					...
					<div className="alert alert-info">
						...
						<span>
							<strong>De grafiek toont:</strong> Je huidige saldo (€{currentBalance.toFixed(2)}) + 
							de maandelijkse groei van €{monthlyOverview?.netAmount.toFixed(2) || '0.00'} = 
							verwacht toekomstig vermogen
						</span>
					</div>
				</div>
			</div>
